...
from tensorflow.python.keras.layers import add, core, multiply, concatenate, BatchNormalization, Lambda, Activation, \
...
class SegmentationModel(AbstractModelNN):
    def __init__(self, config=None):
        super(SegmentationModel, self).__init__(config)
    ...
    def build_model(self):
        ...
        up1 = concatenate(
            [Conv2DTranspose(64, (3, 3), strides=(2, 2), padding='same', activation="relu")(center), attn_1], axis=3)
